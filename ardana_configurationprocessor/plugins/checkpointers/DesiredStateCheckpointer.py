...
from ardana_configurationprocessor.cp.model.CheckpointerPlugin \
    import ArtifactMode
from ardana_configurationprocessor.cp.controller.CloudNameController \
...
class DesiredStateCheckpointer(CheckpointerPlugin):
    def __init__(self, instructions, models, controllers):
        super(DesiredStateCheckpointer, self).__init__(
    ...
    def checkpoint(self):
        ...
        self.prepare_filesystem(cloud_name, 'desired_state')
