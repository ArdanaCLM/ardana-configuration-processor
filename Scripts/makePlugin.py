...
def get_plugin_path(plugin_type, plugin_version):
    value = get_cp_path()
    value = os.path.join(value, 'ardana_configurationprocessor')
...
def create_generator(plugin_path, plugin_name, plugin_mnemonic,
    ...
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.GeneratorPlugin \\\n'
             '    import GeneratorPlugin\n')
    fp.write('from ardana_configurationprocessor.cp.model.CPLogging \\\n'
...
def create_builder(plugin_path, plugin_name, plugin_mnemonic, plugin_version):
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.BuilderPlugin \\\n'
...
def create_checkpointer(plugin_path, plugin_name, plugin_mnemonic,
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.controller'
             '.CloudNameController '
             '\\\n'
             '    import CloudNameController\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.CheckpointerPlugin '
             '\\\n'
...
def create_validator(plugin_path, plugin_name, plugin_mnemonic,
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.ValidatorPlugin \\\n'
...
def create_variable(plugin_path, plugin_name, plugin_mnemonic, plugin_version):
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.VariablePlugin \\\n'
...
def create_explainer(plugin_path, plugin_name, plugin_mnemonic,
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.ExplainerPlugin \\\n'
...
def create_migrator(plugin_path, plugin_name, plugin_mnemonic, plugin_version):
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.MigratorPlugin \\\n'
...
def create_finalizer(plugin_path, plugin_name, plugin_mnemonic,
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.FinalizerPlugin \\\n'
...
def create_relationship(plugin_path, plugin_name, plugin_mnemonic,
    ...
    fp.write('import logging.config\n')
    fp.write('\n')
    fp.write('from ardana_configurationprocessor.cp.model.RelationshipPlugin '
             '\\\n'
...
def update_setup_py(plugin_type, plugin_name, plugin_mnemonic, plugin_version):
    ...
    section = 'ardana.configurationprocessor.%s' % plugin_type_name.lower()
    ...
    if plugin_version == 1:
        line = '%s\'ardana_configurationprocessor.plugins.%ss.\'\n' % \
            (spaces, plugin_type_name.lower())
    else:
        version = str(plugin_version).replace('.', '_')

        line = '%s\'ardana_configurationprocessor.plugins.%ss.%s.\'\n' % \
...
def update_ardana_cp(plugin_type, plugin_name, plugin_mnemonic):
    path = get_driver_path()
    file_name = os.path.join(path, 'ardana-cp')
...
def main():
    ...
    update_ardana_cp(plugin_type, plugin_name, plugin_mnemonic)
